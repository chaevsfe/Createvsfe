 ...
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.CuttingRecipeGen}.
...
public abstract class CuttingRecipeGen extends StandardProcessingRecipeGen<CuttingRecipe> {
	...
	public CuttingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
