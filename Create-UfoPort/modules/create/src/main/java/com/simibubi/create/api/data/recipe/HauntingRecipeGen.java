 ...
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.HauntingRecipeGen}.
...
public abstract class HauntingRecipeGen extends StandardProcessingRecipeGen<HauntingRecipe> {
	...
	public GeneratedRecipe convert(Supplier<Ingredient> input, Supplier<ItemLike> result) {
		return create(asResource(RegisteredObjects.getKeyOrThrow(result.get().asItem())
			.getPath()),
	...
	public HauntingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
