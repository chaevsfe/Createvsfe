...
public class CuttingRecipeGen extends ProcessingRecipeGen {
	...
	ANDESITE_ALLOY = create(I::andesite, b -> b.duration(200).output(AllBlocks.SHAFT.get(), 6)),

			BAMBOO_PLANKS = create(() -> Blocks.BAMBOO_PLANKS, b -> b.duration(20).output(Blocks.BAMBOO_MOSAIC, 1)),
			...
			CRIMSON_WOOD = stripAndMakePlanks(Blocks.CRIMSON_HYPHAE, Blocks.STRIPPED_CRIMSON_HYPHAE,
			...
			DARK_OAK_LOG = stripAndMakePlanks(Blocks.DARK_OAK_LOG, Blocks.STRIPPED_DARK_OAK_LOG,
					Blocks.DARK_OAK_PLANKS),
			MANGROVE_LOG = stripAndMakePlanks(Blocks.MANGROVE_LOG, Blocks.STRIPPED_MANGROVE_LOG,
					Blocks.MANGROVE_PLANKS),
			...
			BTN_4 = stripAndMakePlanks(Mods.BTN, "glimmering_dreamwood_log", "glimmering_stripped_dreamwood_log",
					"dreamwood_planks"),
			BTN_5 = stripAndMakePlanks(Mods.BTN, "glimmering_dreamwood", "glimmering_stripped_dreamwood",
					"dreamwood_planks"),
			...
			BYG = cuttingCompat(Mods.BYG, "aspen", "baobab", "blue_enchanted", "cherry", "cika", "cypress", "ebony",
					"ether", "fir", "green_enchanted", "holly", "jacaranda", "lament", "mahogany", "maple",
					"nightshade", "palm", "pine", "rainbow_eucalyptus", "redwood", "skyris", "willow", "witch_hazel",
					"zelkova"),
			...
			// Twilight Forest
			TF = cuttingCompat(Mods.TF, "twilight_oak", "canopy", "mangrove", "dark", "time", "transformation",
					"mining", "sorting"),
	...
	GeneratedRecipe stripAndMakePlanks(Block wood, Block stripped, Block planks, int planksAmount) {
		create(() -> wood, b -> b.duration(50).output(stripped));
		return create(() -> stripped, b -> b.duration(50).output(planks, planksAmount));
	}
	...
	public CuttingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
