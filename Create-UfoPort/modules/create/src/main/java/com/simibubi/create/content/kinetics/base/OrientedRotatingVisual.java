...
/**
 * Visual for kinetic blocks that need their model oriented to a specific facing direction.
 * Used for shaft halves, bearings, etc. where the model's default orientation doesn't match
 * the block state's facing.
 */
