 ...
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.DeployingRecipeGen}.
 * Needs to be added to a registered recipe provider to do anything, see {@link com.simibubi.create.foundation.data.recipe.CreateRecipeProvider}
 */
public abstract class DeployingRecipeGen extends ProcessingRecipeGen<DeployerApplicationRecipe> {
	...
	public DeployingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
	...
	@Override
	protected ProcessingRecipeBuilder<DeployerApplicationRecipe> getBuilder(ResourceLocation id) {
