...
public class PlayerSkyhookRenderer {
	...
	private static void setHangingPose(boolean isLeftArmMain, HumanoidModel<?> model) {
		...
		var hangingArm = isLeftArmMain ? model.leftArm : model.rightArm;
		var otherArm = isLeftArmMain ? model.rightArm : model.leftArm;
		hangingArm.y -= 3;
		...
		var leadingLeg = isLeftArmMain ? model.leftLeg : model.rightLeg;
		var trailingLeg = isLeftArmMain ? model.rightLeg : model.leftLeg;
