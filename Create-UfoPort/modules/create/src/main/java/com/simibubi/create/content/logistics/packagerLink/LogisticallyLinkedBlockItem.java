...
public class LogisticallyLinkedBlockItem extends BlockItem {
	...
	public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext tooltipContext,
		...
		tooltipComponents.add(Lang.translateDirect("logistically_linked.tooltip_clear")
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
		...
		if (isTuned(stack)) {
			if (level.isClientSide) {
				...
				player.displayClientMessage(Lang.translateDirect("logistically_linked.cleared"), true);
