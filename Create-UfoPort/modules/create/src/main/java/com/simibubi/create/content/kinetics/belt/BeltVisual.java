...
import com.simibubi.create.foundation.render.ScrollInstance;
...
public class BeltVisual extends KineticBlockEntityVisual<BeltBlockEntity> {
	...
	private Model getPulleyModel() {
		...
		return Models.partial(AllPartialModels.BELT_PULLEY, dir.getAxis(), (axis, modelTransform) -> {
			...
			msr.center();
			if (axis == Direction.Axis.X) msr.rotateYDegrees(90);
			if (axis == Direction.Axis.Y) msr.rotateXDegrees(90);
