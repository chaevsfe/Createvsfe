...
public class HandCrankVisual extends KineticBlockEntityVisual<HandCrankBlockEntity> implements SimpleDynamicVisual {
	...
	public HandCrankVisual(VisualizationContext context, HandCrankBlockEntity blockEntity, float partialTick) {
		...
		rotatingModel = instancerProvider().instancer(AllInstanceTypes.ROTATING, blockStateModel(blockState))
			.createInstance();
