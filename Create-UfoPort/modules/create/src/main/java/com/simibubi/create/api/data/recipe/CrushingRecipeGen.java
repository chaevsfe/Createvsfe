 ...
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.CrushingRecipeGen}.
...
public abstract class CrushingRecipeGen extends StandardProcessingRecipeGen<CrushingRecipe> {
	...
	protected GeneratedRecipe mineralRecycling(AllPaletteStoneTypes type, UnaryOperator<ProcessingRecipeBuilder<CrushingRecipe>> transform) {
	...
	public CrushingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
