...
public class TrackBlockOutline {
	...
	public static WorldAttached<Map<BlockPos, TrackBlockEntity>> TRACKS_WITH_TURNS = new WorldAttached<>(
			w -> new HashMap<>());
	...
	public static boolean drawCustomBlockSelection(LevelRenderer context, Camera info, HitResult hitResult,
			DeltaTracker tracker, PoseStack ms, MultiBufferSource buffers) {
	...
	private static final VoxelShape LONG_CROSS = Shapes.or(TrackVoxelShapes.longOrthogonalZ(),
