...
public class Tags implements ModInitializer {
	...
	public static class Items {
		...
		public static final TagKey<Item> DYES_BLACK = DyeColor.BLACK.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_RED = DyeColor.RED.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_GREEN = DyeColor.GREEN.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_BROWN = DyeColor.BROWN.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_BLUE = DyeColor.BLUE.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_PURPLE = DyeColor.PURPLE.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_CYAN = DyeColor.CYAN.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_LIGHT_GRAY = DyeColor.LIGHT_GRAY.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_GRAY = DyeColor.GRAY.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_PINK = DyeColor.PINK.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_LIME = DyeColor.LIME.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_YELLOW = DyeColor.YELLOW.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_LIGHT_BLUE = DyeColor.LIGHT_BLUE.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_MAGENTA = DyeColor.MAGENTA.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_ORANGE = DyeColor.ORANGE.port_lib_ufo$getDyesTag();
		public static final TagKey<Item> DYES_WHITE = DyeColor.WHITE.port_lib_ufo$getDyesTag();
