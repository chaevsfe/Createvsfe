 ...
 * to make recipes.
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.FillingRecipeGen}.
...
public abstract class FillingRecipeGen extends StandardProcessingRecipeGen<FillingRecipe> {
	...
	public FillingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
