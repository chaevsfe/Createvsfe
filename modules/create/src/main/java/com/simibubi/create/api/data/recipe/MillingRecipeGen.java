 ...
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.MillingRecipeGen}.
...
public abstract class MillingRecipeGen extends StandardProcessingRecipeGen<MillingRecipe> {
	...
	public MillingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
