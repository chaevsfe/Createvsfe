...
public class ComputerBehaviour extends AbstractComputerBehaviour {
	...
	public void removePeripheral() {
		// On Fabric, CC:Tweaked discovers peripherals via its own block entity provider system.
		// No capability invalidation needed — CC's internal cache handles cleanup.
		peripheral = null;
	}
