...
public class FlapDisplaySection {
	...
	public CompoundTag write() {
		...
		if (component != null)
			tag.putString("Text", Component.Serializer.toJson(component, Create.getRegistryAccess()));
		if (sendTransition)
	...
	public static FlapDisplaySection load(CompoundTag tag) {
		...
		section.component = Component.Serializer.fromJson(tag.getString("Text"), Create.getRegistryAccess());
