 ...
 * For an example of how you might do this, see Create's implementation: {@link com.simibubi.create.foundation.data.recipe.WashingRecipeGen}.
...
public abstract class WashingRecipeGen extends StandardProcessingRecipeGen<SplashingRecipe> {
	...
	public WashingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
