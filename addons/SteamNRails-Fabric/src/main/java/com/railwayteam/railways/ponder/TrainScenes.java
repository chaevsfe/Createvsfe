...
//        scene.rotateCameraY(85);
        ...
        for (int i = 0; i < 3; i++) {
            scene.world.createEntity((level) -> {
                Arrow arrowBase = new Arrow(EntityType.ARROW, level);
                arrowBase.setPos(switchPos.getX() + 0.5, 30, switchPos.getZ() + 0.5);
                /* TODO: port anonymous Arrow subclass with onHitBlock override to 1.21.1 */
                return arrowBase;
            });
            scene.idle(20);
