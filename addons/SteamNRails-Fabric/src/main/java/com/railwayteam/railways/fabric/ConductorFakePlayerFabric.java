...
public class ConductorFakePlayerFabric extends FakePlayer implements IConductorHoldingFakePlayer {
	...
	// getEyeHeight is final in Entity in 1.21.1; eye height is determined via EntityDimensions.eyeHeight
	...
	// eat(Level, ItemStack) is final in LivingEntity in 1.21.1
