...
public class TrackBufferBlockItem extends TrackTargetingBlockItem {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (state.getBlock() instanceof ITrackBlock track) {
            ...
            CustomData existingBlockEntityData = stack.get(DataComponents.BLOCK_ENTITY_DATA);

            CompoundTag teTag = new CompoundTag();
            if (existingBlockEntityData != null) {
                CompoundTag oldTeTag = existingBlockEntityData.getUnsafe();
