...
public abstract class RailwaysMechanicalCraftingRecipeGen extends RailwaysRecipeProvider {
    ...
    protected RailwaysMechanicalCraftingRecipeGen(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
    ...
    public static RailwaysMechanicalCraftingRecipeGen create(FabricDataOutput gen, CompletableFuture<HolderLookup.Provider> registriesFuture)  {
        return new RailwaysMechanicalCraftingRecipeGenImpl(gen, registriesFuture);
    }
