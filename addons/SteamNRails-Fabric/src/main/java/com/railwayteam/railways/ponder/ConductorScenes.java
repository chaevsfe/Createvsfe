...
public class ConductorScenes {
  ...
  public static ElementLink<EntityElement> makePlayerStand(SceneBuilder scene, String playerName, int leatherColor, Vec3 pos) {
    ...
    playerHead.set(DataComponents.PROFILE, new ResolvableProfile(Optional.of(playerName), Optional.empty(), new com.mojang.authlib.properties.PropertyMap()));
    ...
    scene.world.modifyEntity(player, entity -> {
      ...
      stand.setItemSlot(EquipmentSlot.HEAD, playerHead);
      ItemStack chestplate = new ItemStack(Items.LEATHER_CHESTPLATE);
      ItemStack leggings = new ItemStack(Items.LEATHER_LEGGINGS);
      ItemStack boots = new ItemStack(Items.LEATHER_BOOTS);
      chestplate.set(DataComponents.DYED_COLOR, new DyedItemColor(leatherColor, true));
      leggings.set(DataComponents.DYED_COLOR, new DyedItemColor(leatherColor, true));
      boots.set(DataComponents.DYED_COLOR, new DyedItemColor(leatherColor, true));
  ...
  public static void redstoning(SceneBuilder scene, SceneBuildingUtil util) {
    ...
    scene.world.modifyEntity(player, entity -> {
      if (entity instanceof ArmorStand stand)
        stand.setItemSlot(EquipmentSlot.HEAD, CRItems.ITEM_CONDUCTOR_CAP.get(DyeColor.RED).asStack());
    });
