...
import io.github.fabricators_of_create.porting_lib_ufo.models.generators.CustomLoaderBuilder;
...
public class ObjModelBuilder<T extends ModelBuilder<T>> extends CustomLoaderBuilder<T> {
    ...
    private static final ResourceLocation PORTING_LIB_LOADER = ResourceLocation.fromNamespaceAndPath("porting_lib_ufo", "loader");
    private static final ResourceLocation PORTING_LIB_OBJ = ResourceLocation.fromNamespaceAndPath("porting_lib_ufo", "obj");
