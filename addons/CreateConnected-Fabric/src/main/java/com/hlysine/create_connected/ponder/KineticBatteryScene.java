...
public class KineticBatteryScene {
    ...
    public static void kineticBatteryAutomation(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(battery, Direction.UP), Pointing.DOWN).withItem(AllItems.WRENCH.asStack()), 30);
        scene.idle(30);
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(battery, Direction.UP), Pointing.DOWN).withItem(CCItems.CHARGED_KINETIC_BATTERY.asStack()), 30);
        scene.idle(30);
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(battery, Direction.UP), Pointing.DOWN).withItem(CCBlocks.KINETIC_BATTERY.asStack()), 30);
        scene.idle(30);
        scene.world.modifyBlock(battery, state -> state.setValue(KineticBatteryBlock.LEVEL, 0), false);
        ...
        scene.world.modifyBlockEntityNBT(util.select.position(deployer), DeployerBlockEntity.class, nbt -> nbt.put("HeldItem", CCItems.CHARGED_KINETIC_BATTERY.asStack().saveOptional(Create.getRegistryAccess())));
