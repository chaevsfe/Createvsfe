...
public class LinkedTransmitterScenes {
    public static void linkedTransmitter(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(transmitVec, Pointing.UP).rightClick().withItem(new ItemStack(CCItems.LINKED_TRANSMITTER.get())), 40);
        scene.idle(10);
        ...
        scene.world.modifyBlockEntityNBT(leverSelect, LinkedTransmitterBlockEntity.class,
                nbt -> nbt.put("FrequencyLast", iron.saveOptional(Create.getRegistryAccess())));
        scene.idle(7);
        scene.world.modifyBlockEntityNBT(leverSelect, LinkedTransmitterBlockEntity.class,
                nbt -> nbt.put("FrequencyFirst", sapling.saveOptional(Create.getRegistryAccess())));
        scene.idle(20);
        ...
        scene.world.modifyBlockEntityNBT(linkLeftSelect, RedstoneLinkBlockEntity.class,
                nbt -> nbt.put("FrequencyLast", gold.saveOptional(Create.getRegistryAccess())));
        scene.idle(7);
        scene.world.modifyBlockEntityNBT(linkLeftSelect, RedstoneLinkBlockEntity.class,
                nbt -> nbt.put("FrequencyFirst", sapling.saveOptional(Create.getRegistryAccess())));
        scene.idle(20);
        ...
        scene.overlay.showText(40)
                ...
                .pointAt(transmitVec);
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(transmitVec, Pointing.DOWN).rightClick().whileSneaking(), 40);
        scene.idle(20);
        ...
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(analogLever, Direction.DOWN).add(0, 4 / 16.0, 0), Pointing.UP).rightClick().withItem(new ItemStack(CCItems.LINKED_TRANSMITTER.get())), 40);
        scene.idle(5);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(button, Direction.DOWN).add(0, 2 / 16.0, 0), Pointing.DOWN).rightClick().withItem(new ItemStack(CCItems.LINKED_TRANSMITTER.get())), 40);
        scene.idle(20);
        ...
        scene.overlay.showControls(new InputWindowElement(transmitVec, Pointing.DOWN).rightClick().withItem(new ItemStack(AllItems.WRENCH.get())), 40);
        scene.idle(20);
